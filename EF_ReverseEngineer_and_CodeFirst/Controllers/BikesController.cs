...
namespace EF_ReverseEngineer_and_CodeFirst.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class BikesController : ControllerBase
    {
        private readonly ExistingContextDb _context;

        public BikesController(ExistingContextDb context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Bike>> PostBike(Bike bike)
        {
          if (_context.Bikes == null)
          {
              return Problem("Entity set 'ExistingContextDb.Bikes'  is null.");
          }
